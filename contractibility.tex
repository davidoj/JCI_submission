...
This symmetry is conceptually very similar to exchangeability, and as we will show that it implies that the $(\RV{D}_i,\RV{Y}_i)$ share conditionally independent and identical responses. However, the converse is not true, as Example \ref{ex:no_swapping} shows.
...
\subsection{Background}\label{sec:rep_theorem_background}
